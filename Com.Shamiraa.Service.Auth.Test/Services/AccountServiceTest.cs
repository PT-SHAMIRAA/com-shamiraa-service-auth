...
using Com.Shamiraa.Service.Auth.Lib.BusinessLogic.Services;
using Com.Shamiraa.Service.Auth.Lib.Models;
using Com.Shamiraa.Service.Auth.Lib.ViewModels;
using Com.Shamiraa.Service.Auth.Test.DataUtils;
using Com.Shamiraa.Service.Auth.Test.Utils;
using Moq;
using System;
...
namespace Com.Shamiraa.Service.Auth.Test.Services
{
