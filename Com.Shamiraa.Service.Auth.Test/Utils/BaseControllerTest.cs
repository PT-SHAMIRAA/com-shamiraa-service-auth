...
using Com.Shamiraa.Service.Auth.Lib.Utilities;
using Com.Shamiraa.Service.Auth.Lib.Utilities.BaseClass;
...
namespace Com.Shamiraa.Service.Auth.Test.Utils
{
        ...
        where IService : class, IBaseService<TModel>
    {
        ...
        protected TController GetController((Mock<IIdentityService> IdentityService, Mock<IValidateService> ValidateService, Mock<IService> Service, Mock<IMapper> Mapper) mocks)
        {
            ...
            TController controller = (TController)Activator.CreateInstance(typeof(TController), mocks.IdentityService.Object, mocks.ValidateService.Object, mocks.Service.Object, mocks.Mapper.Object);
        ...
        private int GetStatusCodeGet((Mock<IIdentityService> IdentityService, Mock<IValidateService> ValidateService, Mock<IService> Service, Mock<IMapper> Mapper) mocks)
        {
        ...
        private async Task<int> GetStatusCodeGetById((Mock<IIdentityService> IdentityService, Mock<IValidateService> ValidateService, Mock<IService> Service, Mock<IMapper> Mapper) mocks)
        {
            TController controller = GetController(mocks);
        ...
        private async Task<int> GetStatusCodePut((Mock<IIdentityService> IdentityService, Mock<IValidateService> ValidateService, Mock<IService> Service, Mock<IMapper> Mapper) mocks, int id, TViewModel viewModel)
        {
            TController controller = GetController(mocks);
        ...
        private async Task<int> GetStatusCodeDelete((Mock<IIdentityService> IdentityService, Mock<IValidateService> ValidateService, Mock<IService> Service, Mock<IMapper> Mapper) mocks)
        {
            TController controller = GetController(mocks);
